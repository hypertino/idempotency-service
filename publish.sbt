...
pomExtra :=
  <url>https://github.com/hypertino/idempotency-service</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/idempotency-service.git</url>
      <connection>scm:git:git@github.com:hypertino/idempotency-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
